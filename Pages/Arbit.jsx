    ...
    <View style={styles.container}>
      <SafeAreaView>
        <ScrollView>
          ...
          <Pressable
            style={styles.button}
            onPress={() => navigation.navigate("PDF", { ruta: "arbit" })}
          >
            <Text style={styles.textoDeLosBotones}>
              Arbit de Jol y Motzae Shabat
            </Text>
          </Pressable>
          <Pressable
            style={styles.button}
            onPress={() => navigation.navigate("PDF", { ruta: "keriatShema" })}
          >
            <Text style={styles.textoDeLosBotones}>
              Keriat Shema Shel Amita
            </Text>
          </Pressable>
